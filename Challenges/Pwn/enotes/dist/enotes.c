// I followed all the secure coding practices too! No one's gonna hack me now!
    ...
    while (1) {
        ...
        if (strcmp(buffer, "read") == 0) {
            ...
            if (index >= MAX_MESSAGES || index < 0)
                ...
                if (notes[index]) { // ain't gonna double free me!
                    free(notes[index]);
                    notes[index] = 0; //haha where's your UAF now???
                }
            }
